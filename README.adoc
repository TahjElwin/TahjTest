[[s2i-aspnet-example]]
== This is Tahj's Test build where he is learning how to edit and upload different things to understand K8 and some of its features
This repository contains an example project that can be built using the
ANGE his repository contains an example project that can be built using the
